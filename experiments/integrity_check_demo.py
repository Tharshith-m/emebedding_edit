...
# # -----------------------------
# # base_store = EmbeddingStore(vocab=vocab, dim=32)
# # base_store.initialize()

# base_store = EmbeddingStore.load(
#     "embeddings/base_embeddings.safetensors"
# )


# # Register trusted hashes
...
# # -----------------------------
# # Load tampered embeddings
# # -----------------------------
# tampered_store = EmbeddingStore.load(
#     "embeddings/tampered_embeddings_1767542921.safetensors"
# )
...
#     status = "✅ INTACT" if results[token_id] else "❌ TAMPERED"
...
#     raise FileNotFoundError("❌ No tampered embedding files found")
