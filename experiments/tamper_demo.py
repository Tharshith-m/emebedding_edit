...
# # store.save("embeddings/base_embeddings.safetensors")

# # print("✅ Embedding matrix created and stored securely")
...
# TAMPER_SCALE = 0.5  # how strong the attack is


# # -----------------------------
# # Step 2: Load base embeddings
# # -----------------------------
# store = EmbeddingStore(vocab=vocab, dim=32)
# store.initialize()
# # store.save("embeddings/base_embeddings.safetensors")
# # store.save("embeddings/base_embeddings.safetensors", overwrite=True)
# import time
...
# print(original_vector[:5])  # show first 5 values only
...
# store.save("embeddings/tampered_embeddings.safetensors")
